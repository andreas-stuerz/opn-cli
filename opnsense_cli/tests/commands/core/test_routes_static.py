...
class TestRoutesStaticCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"route": {"route": []}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            static,
            ["list", "-o", "plain", "-c", "network,gateway"],
        )

        self.assertIn(("10.50.2.2/24 Null4\n10.0.0.98/24 WAN_DHCP\n"), result.output)
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            static,
            ["show", "7905f696-4692-47aa-b39f-1a8cda5d60c1", "-o", "plain", "-c", "network,gateway,descr,disabled"],
        )

        self.assertIn(("10.0.0.98/24 WAN_DHCP Test route 2 0\n"), result.output)
    ...
    def test_create_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            static,
            ["create", "--network", "10.0.5.1/24", "--gateway", "Null4"],
        )
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            static,
            ["create", "--network", "10.0.5.1/24", "--gateway", "Null5"],
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "update",
                "7905f696-4692-47aa-b39f-1a8cda5d60c1",
                "--disabled",
            ],
        )
