...
class TestUnboundAliasCommands(CommandTestCase):
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            alias,
            ["list", "-o", "plain", "-c", "uuid,enabled,Host,hostname,domain,description"],
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            alias,
            ["show", "c2ab1046-6bc8-4b89-8542-2561f560424c", "-o", "plain", "-c", "uuid,Host,hostname,domain,description"],
        )
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        ...
        self.assertIn(
            ("Error: {'result': 'failed', 'validations': " "{'alias.domain': 'A valid domain must be specified.'}}\n"),
            result.output,
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            alias,
            ["update", "c2ab1046-6bc8-4b89-8542-2561f560424c", "--host", "host01|example.com|A|||10.0.0.1"],
        )
