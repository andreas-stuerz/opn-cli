...
class TestOpenvpnCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_templates = {
            ...
            "PlainOpenVPN": {"name": "File Only", "supportedOptions": ["plain_config", "random_local_port", "auth_nocache"]},
        ...
        self._api_data_fixtures_accounts = {
            "57194c007be18": {"description": "vpnuser1", "users": []},
            "57194c17cab84": {"description": "vpnuser2", "users": []},
        }
    ...
    def test_providers(self, api_response_mock):
        ...
        self.assertIn("2 OpenVPN Server UDP:1194 server_tls 2 vpn.example.com PlainOpenVPN 1194\n", result.output)
    ...
    def test_accounts(self, api_response_mock):
        ...
        self.assertIn("57194c007be18 vpnuser1 []\n" + "57194c17cab84 vpnuser2 []\n", result.output)
    ...
    def test_download(self, api_response_mock):
        ...
        self.assertIn("OpenVPN_Server_vpnuser1.ovpn T3BlblZQTiBjZXJ0aWZpY2F0ZQo=\n", result.output)
