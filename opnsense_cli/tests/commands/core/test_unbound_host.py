...
class TestUnboundHostCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"unbound": {"hosts": {"host": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            host,
            ["list", "-o", "plain", "-c", "uuid,hostname,domain,rr,server"],
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            host,
            ["show", "65da9ff2-dc95-48a4-82e0-a00428d64e39", "-o", "plain", "-c", "uuid,hostname,domain,rr,server"],
        )

        self.assertIn(("65da9ff2-dc95-48a4-82e0-a00428d64e39 host01 example.com A 10.0.0.1\n"), result.output)
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        ...
        self.assertIn(
            ("Error: {'result': 'failed', 'validations': " "{'host.domain': 'A valid domain must be specified.'}}\n"),
            result.output,
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "update",
                "65da9ff2-dc95-48a4-82e0-a00428d64e39",
                "--description",
                "updated example host description",
                "--server",
                "10.0.10.1",
            ],
        )
    ...
    def test_delete_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "delete",
                "8111ce26-08f6-4b2b-95d8-4d27f1121ed9",
            ],
        )
