...
class TestHaproxyFrontendCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"frontends": {"frontend": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            frontend,
            ["list", "-o", "plain", "-c", "uuid,enabled,name,bind,mode,Backend,ssl_enabled,ssl_certificates"],
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "show",
                "6c19c893-2c38-4944-9540-a2af1eb2b7d3",
                "-o",
                "plain",
                "-c",
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                ...
                "127.0.0.1:8080",
                "--defaultBackend",
                "5d17779f-1407-4cdf-a616-b7024bea4448",
                "--ssl_enabled",
                "--ssl_certificates",
                "does_not_exists",
            ],
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            frontend,
            ["update", "6c19c893-2c38-4944-9540-a2af1eb2b7d3", "--enabled"],
        )
