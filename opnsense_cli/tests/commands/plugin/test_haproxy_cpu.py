...
class TestHaproxyCpuCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"cpus": {"cpu": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            cpu,
            ["list", "-o", "plain", "-c", "uuid,enabled,name,process_id,thread_id,cpu_id"],
        )

        self.assertIn(("1ce4a03b-e69c-4ea7-a506-59b9b074e644 1 my_affinit_rule all all x0\n"), result.output)
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "show",
                "1ce4a03b-e69c-4ea7-a506-59b9b074e644",
                "-o",
                "plain",
                "-c",
