...
class TestHaproxyHealthcheckCommands(CommandTestCase):
    ...
    def test_list(self, api_response_mock: Mock):
        ...
        self.assertIn(
            (
                "5fc21dc7-5a0e-48ba-bc17-a7d41f5dadde http_head Monitor http http 2s\n"
            ),
            result.output
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            healthcheck,
            [
                'show', '5fc21dc7-5a0e-48ba-bc17-a7d41f5dadde', '-o', 'plain', '-c',
                'uuid,name,description,type,interval'
            ]
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            healthcheck,
            [
                "update", "5fc21dc7-5a0e-48ba-bc17-a7d41f5dadde",
                "--description", "updated by me"
            ]
        )
