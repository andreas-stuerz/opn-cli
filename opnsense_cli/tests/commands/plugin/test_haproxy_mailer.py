...
class TestHaproxyMailerCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"mailers": {"mailer": []}}}
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "show",
                "30701b82-a255-4566-9a3e-04e52bb46b9a",
                "-o",
                "plain",
                "-c",
        ...
        self.assertIn(("1 alert_to_myself Alert to myself 192.168.1.1:25 as@test.de as@test.de alert 30 \n"), result.output)
