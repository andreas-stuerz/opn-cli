...
class TestHaproxyAclCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"acls": {"acl": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            acl,
            ["list", "-o", "plain", "-c", "uuid,name,description,expression,negate"],
        )

        self.assertIn(("0a5b6c77-7a3a-4cb1-9a38-9ace2756c68e my_condition  http_auth 0\n"), result.output)
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            acl,
            ["show", "0a5b6c77-7a3a-4cb1-9a38-9ace2756c68e", "-o", "plain", "-c", "uuid,name,description,expression,negate"],
        )
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            acl,
            ["create", "my_test_acl", "--expression", "ssl_c_verify_code", "--ssl_c_verify_code", 100000000000],
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            acl,
            ["update", "0a5b6c77-7a3a-4cb1-9a38-9ace2756c68e", "--no-negate"],
        )
    ...
    def test_delete_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "delete",
                "0a5b6c77-7a3a-4cb1-9a38-9ace2756c68e",
            ],
        )
