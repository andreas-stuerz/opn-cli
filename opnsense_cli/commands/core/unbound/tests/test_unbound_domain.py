...
class TestUnboundDomainCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"unbound": {"domains": {"domain": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            domain,
            ["list", "-o", "plain", "-c", "uuid,enabled,domain,server,description"],
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            domain,
            ["show", "1e4485f5-24d0-42de-8631-ab906f377e92", "-o", "plain", "-c", "uuid,enabled,domain,server,description"],
        )
    ...
    def test_create_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            domain,
            ["create", "--domain", "domain.xyz.de", "--server", "192.168.40.2", "--description", "domain ovveride"],
        )
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            domain,
            ["create", "--domain", "domain.xyz.de", "--server", "invalid", "--description", "domain ovveride"],
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            domain,
            ["update", "1e4485f5-24d0-42de-8631-ab906f377e92", "--server", "192.168.56.1"],
        )
    ...
    def test_delete_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "delete",
                "1e4485f5-24d0-42de-8631-ab906f377e92",
            ],
        )
