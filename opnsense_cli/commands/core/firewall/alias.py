...
from opnsense_cli.callbacks.click import formatter_from_formatter_name, bool_as_string, comma_to_newline, available_formats
...
def update(firewall_alias_svc: FirewallAliasFacade, **kwargs):
    ...
    See: https://wiki.opnsense.org/manual/aliases.html
    """
    json_payload = {"alias": {"name": kwargs["alias_name"]}}
    options = ["enabled", "name", "type", "content", "description", "proto", "updatefreq", "counters"]
