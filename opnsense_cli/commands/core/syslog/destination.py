...
@click.option(
    ...
    default=("uuid,enabled,transport,program,level,facility,hostname,certificate,port,rfc5424,description"),
    show_default=True,
)
...
@click.option(
    ...
    "-c",
    help="Which columns should be printed? Pass empty string (-c " ") to show all columns",
    default=("enabled,transport,program,level,facility,hostname,certificate,port,rfc5424,description"),
    show_default=True,
)
@pass_syslog_destination_svc
...
@click.option("--hostname", help=("The hostname or ip address of the syslog destination."), show_default=True, default=None)
@click.option(
    "--certificate",
    help=(
        """
...
@click.option("--port", help=("The port of the syslog destination."), show_default=True, default=None)
@click.option(
    "--rfc5424/--no-rfc5424",
    help=("Use rfc5424 formated messages for this destination."),
    show_default=True,
