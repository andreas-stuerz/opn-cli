...
class TestSyslogDestinationCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"syslog": {"destinations": {"destination": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            destination,
            ["list", "-o", "plain", "-c", "uuid,enabled,transport,program"],
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            destination,
            ["show", "4dd6f818-e975-4136-bf7e-ed2559675ef9", "-o", "plain", "-c", "uuid,enabled,transport,program"],
        )

        self.assertIn(("4dd6f818-e975-4136-bf7e-ed2559675ef9 1 tcp4 firewall,charon,lighttpd,ntp\n"), result.output)
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            destination,
            ["create", "--hostname", "xyz_something_strange", "--program", "doesnotexists"],
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            destination,
            ["update", "7155fe8c-d878-4690-be73-e9811a7c7da4", "--port", "10001"],
        )
