...
from opnsense_cli.click_addons.callbacks import formatter_from_formatter_name, available_formats, tuple_to_csv
...
@click.option(
    ...
    default=("uuid,name,description,code,content"),
    show_default=True,
)
...
@click.option(
    ...
    "-c",
    help="Which columns should be printed? Pass empty string (-c " ") to show all columns",
    default=("name,description,code,content"),
    show_default=True,
)
@pass_haproxy_errorfile_svc
...
@errorfile.command()
@click.argument("uuid")
@click.option("--name", help=("Name to identify this error message."), show_default=True, default=None)
@click.option("--description", help=("Description for this error message."), show_default=True, default=None)
@click.option(
    "--code",
    help=(
        "The HTTP status code. NOTE: It is important to understand that error messages are NOT meant to "
