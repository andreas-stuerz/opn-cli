...
@click.option(
    ...
    default=("uuid,name,description,type,interval"),
    show_default=True,
)
...
@healthcheck.command()
@click.argument("uuid")
@click.option("--name", help=("Name to identify this Health Monitor."), show_default=True, default=None)
@click.option("--description", help=("Description for this Health Monitor."), show_default=True, default=None)
@click.option(
    "--type",
    help=("Select type of health check."),
    type=click.Choice(["tcp", "http", "agent", "ldap", "mysql", "pgsql", "redis", "smtp", "esmtp", "ssl"]),
...
@click.option("--http_uri", help=("Specify HTTP request URI for health check."), show_default=True, default=None)
@click.option(
    "--http_version",
    help=("Select HTTP version for a HTTP health check."),
    type=click.Choice(["", "http10", "http11", "http2"]),
...
@click.option(
    "--http_host", help=("Specify HTTP host to use for health check. Requires HTTP/1.1."), show_default=True, default=None
)
@click.option(
    "--http_expressionEnabled/--no-http_expressionEnabled",
    help=("None"),
...
@click.option(
    "--mysql_user", help=("Specify the username to be used for database health checks."), show_default=True, default=None
)
@click.option(
    "--mysql_post41/--no-mysql_post41",
    help=("Send checks compatible with MySQL server 4.1 and later."),
...
@click.option(
    "--pgsql_user", help=("Specify the username to be used for database health checks."), show_default=True, default=None
)
@click.option(
    "--smtp_domain",
    help=("Specify the domain name to present to the server for SMTP health checks."),
...
@click.option(
    "--agentPort", help=("Agent check port"), show_default=True, type=INT_OR_EMPTY, callback=int_as_string, default=None
)
@click.option("--dbUser", help=("MySQL database user"), show_default=True, default=None)
@click.option("--smtpDomain", help=("None"), show_default=True, default=None)
@click.option(
    "--output",
    "-o",
    help="Specifies the Output format.",
