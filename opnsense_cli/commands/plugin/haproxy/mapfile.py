...
@click.option(
    ...
    default=("uuid,name,description,content"),
    show_default=True,
)
...
@mapfile.command()
@click.argument("uuid")
@click.option("--name", help=("Name to identify this map file."), show_default=True, default=None)
@click.option("--description", help=("Description for this map file."), show_default=True, default=None)
@click.option("--content", help=("Paste the content of your map file here."), show_default=True, default=None)
@click.option(
    "--output",
    "-o",
    help="Specifies the Output format.",
