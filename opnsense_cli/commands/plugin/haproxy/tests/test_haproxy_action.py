...
class TestHaproxyActionCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"actions": {"action": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            action,
            ["list", "-o", "plain", "-c", "uuid,name,description,testType,Acls,operator,type"],
        )

        self.assertIn(("b1b621ba-e4fc-4f13-bf76-34a2c78a8980 my_rule custom rule if  and use_backend\n"), result.output)
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "show",
                "b1b621ba-e4fc-4f13-bf76-34a2c78a8980",
                "-o",
                "plain",
                "-c",
        ...
        self.assertIn(("my_rule custom rule if  and use_backend      \n"), result.output)
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            action,
            ["create", "my_test_action2", "--type", "use_backend", "--http_response_set_status_code", "700000"],
        )
