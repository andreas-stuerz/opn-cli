...
class TestHaproxyResolverCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_create_ERROR = {
            "result": "failed",
            "validations": {
                "resolver.timeout_retry": "Should be a number between 1 and 8 characters, "
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"resolvers": {"resolver": []}}}
    ...
    def test_show(self, api_response_mock: Mock):
        ...
        self.assertIn(("1 resolver1 my special resolver 127.0.0.1:53 0 3 1s 1s\n"), result.output)
    ...
    def test_create_ERROR(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            resolver,
            ["create", "my_test_resolver", "--timeout_retry", "5x"],
        )
