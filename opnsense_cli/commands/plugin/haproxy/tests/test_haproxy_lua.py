...
class TestHaproxyLuaCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"luas": {"lua": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            lua,
            ["list", "-o", "plain", "-c", "uuid,enabled,name,description,content"],
        )
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            lua,
            ["show", "ffe95743-837c-4a38-98bd-6beafcbd6fa5", "-o", "plain", "-c", "enabled,name,description,content"],
        )
    ...
    def test_create_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            lua,
            ["create", "my_test_lua", "--content", "-- a comment"],
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            lua,
            ["update", "ffe95743-837c-4a38-98bd-6beafcbd6fa5", "--content", "-- another comment"],
        )
    ...
    def test_delete_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "delete",
                "ffe95743-837c-4a38-98bd-6beafcbd6fa5",
            ],
        )
