...
class TestHaproxyMapfileCommands(CommandTestCase):
    def setUp(self):
        ...
        self._api_data_fixtures_list_EMPTY = {"haproxy": {"mapfiles": {"mapfile": []}}}
    ...
    def test_list(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            mapfile,
            ["list", "-o", "plain", "-c", "uuid,name,description,content"],
        )

        self.assertIn(("9a7e6b2d-66fe-487f-9ac4-541dd8f2f639 mapped_file1 custom mapped files .\n"), result.output)
    ...
    def test_show(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            mapfile,
            ["show", "9a7e6b2d-66fe-487f-9ac4-541dd8f2f639", "-o", "plain", "-c", "name,description,content"],
        )

        self.assertIn(("mapped_file1 custom mapped files .\n"), result.output)
    ...
    def test_create_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            mapfile,
            ["create", "my_test_mapfile", "--content", ".."],
        )
    ...
    def test_update_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            mapfile,
            ["update", "9a7e6b2d-66fe-487f-9ac4-541dd8f2f639", "--content", "."],
        )
    ...
    def test_delete_OK(self, api_response_mock: Mock):
        result = self._opn_cli_command_result(
            ...
            [
                "delete",
                "9a7e6b2d-66fe-487f-9ac4-541dd8f2f639",
            ],
        )
