...
@click.option(
    ...
    default=("uuid,name,description,expression,negate"),
    show_default=True,
)
...
@click.option(
    "--src_conn_cur",
    help=("The current amount of concurrent connections initiated from the current incoming connection's source address."),
    show_default=True,
    type=INT_OR_EMPTY,
    callback=int_as_string,
    default=None,
...
@click.option(
    "--ssl_sni_sub",
    help=("The value of the Server Name TLS extension sent by a client contains the specified string (substring match)."),
    show_default=True,
    default=None,
    required=False,
)
@click.option(
    "--ssl_sni_beg",
    help=("The value of the Server Name TLS extension sent by a client starts with the specified string (prefix match)."),
    show_default=True,
    default=None,
    required=False,
)
...
@acl.command()
@click.argument("uuid")
@click.option("--name", help=("Name to identify this condition."), show_default=True, default=None)
@click.option("--description", help=("Description for this condition."), show_default=True, default=None)
@click.option(
    "--expression",
    help=("None"),
    type=click.Choice(
...
@click.option("--hdr_beg", help=("HTTP host header starts with string (prefix match)"), show_default=True, default=None)
@click.option("--hdr_end", help=("HTTP host header ends with string (suffix match)"), show_default=True, default=None)
@click.option("--hdr", help=("HTTP host header matches exact string"), show_default=True, default=None)
@click.option("--hdr_reg", help=("HTTP host header matches regular expression"), show_default=True, default=None)
@click.option("--hdr_sub", help=("HTTP host header contains string (substring match)"), show_default=True, default=None)
@click.option("--path_beg", help=("HTTP request URL path starts with string (prefix match)"), show_default=True, default=None)
@click.option("--path_end", help=("HTTP request URL path ends with string (suffix match)"), show_default=True, default=None)
@click.option("--path", help=("HTTP request URL path matches exact string"), show_default=True, default=None)
@click.option("--path_reg", help=("HTTP request URL path matches regular expression"), show_default=True, default=None)
@click.option("--path_dir", help=("HTTP request URL path contains directory (subdir match)"), show_default=True, default=None)
@click.option("--path_sub", help=("HTTP request URL path contains string (substring match)"), show_default=True, default=None)
@click.option("--cust_hdr_beg_name", help=("The name of the HTTP Header."), show_default=True, default=None)
@click.option("--cust_hdr_beg", help=("HTTP Header starts with string (prefix match)"), show_default=True, default=None)
@click.option("--cust_hdr_end_name", help=("The name of the HTTP Header."), show_default=True, default=None)
@click.option("--cust_hdr_end", help=("HTTP Header ends with string (suffix match)"), show_default=True, default=None)
@click.option("--cust_hdr_name", help=("The name of the HTTP Header."), show_default=True, default=None)
@click.option("--cust_hdr", help=("HTTP Header matches exact string"), show_default=True, default=None)
@click.option("--cust_hdr_reg_name", help=("The name of the HTTP Header."), show_default=True, default=None)
@click.option("--cust_hdr_reg", help=("HTTP Header matches regular expression"), show_default=True, default=None)
@click.option("--cust_hdr_sub_name", help=("The name of the HTTP Header."), show_default=True, default=None)
@click.option("--cust_hdr_sub", help=("HTTP Header contains string (substring match)"), show_default=True, default=None)
@click.option(
    "--url_param",
    help=("Specify the URL parameter to be checked for the value specified below."),
    show_default=True,
...
@click.option("--url_param_value", help=("Specify the value for the URL parameter."), show_default=True, default=None)
@click.option(
    "--ssl_c_verify_code",
    help=(
        "Specify the SSL/TLS error ID that should be checked for the incoming connection. "
...
@click.option("--src_sess_rate", help=("None"), show_default=True, type=INT_OR_EMPTY, callback=int_as_string, default=None)
@click.option(
    "--nbsrv",
    help=("Verify the minimum number of usable servers in the named backend matches the specified value."),
    show_default=True,
...
@click.option("--value", help=("None"), show_default=True, default=None)
@click.option("--urlparam", help=("None"), show_default=True, default=None)
@click.option(
    "--queryBackend", help=("None"), callback=resolve_linked_names_to_uuids, type=CSV, show_default=True, default=None
)
@click.option(
    "--allowedUsers", help=("None"), callback=resolve_linked_names_to_uuids, type=CSV, show_default=True, default=None
)
@click.option(
    "--allowedGroups", help=("None"), callback=resolve_linked_names_to_uuids, type=CSV, show_default=True, default=None
)
@click.option(
    "--output",
    "-o",
