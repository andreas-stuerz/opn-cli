...
@click.option(
    ...
    default=(
        "uuid,enabled,name,description,mode,algorithm,Servers," "healthCheckEnabled,Healthcheck,persistence,stickiness_pattern"
    ),
)
...
@click.option(
    "--tuning_retries",
    help=("Set the number of retries to perform on a server after a connection failure."),
    show_default=True,
    type=INT_OR_EMPTY,
    callback=int_as_string,
    default=None,
...
@click.option(
    "--customOptions",
    help=("These lines will be added to the HAProxy backend configuration."),
    show_default=True,
    default=None,
    required=False,
)
@click.option(
    ...
    help=("Default option for all server entries."),
    show_default=True,
    default=None,
    required=False,
)
@click.option(
    ...
    help=(
        "Don't use port on server, use the same port as frontend receive. " "If check enable, require port check in server."
    ),
    show_default=True,
    is_flag=True,
    callback=bool_as_string,
...
@click.option(
    "--tuning_httpreuse",
    help=("Declare how idle HTTP connections may be shared between requests."),
...
@click.option("--name", help="The name of the backend pool.", show_default=True, default=None)
@click.option("--description", help="Description for this backend pool.", show_default=True, default=None)
@click.option(
    "--mode",
    help="Set the running mode or protocol of the backend pool.",
    type=click.Choice(["http", "tcp"]),
...
@click.option("--persistence_cookiename", help="Cookie name to use for persistence.", show_default=True, default=None)
@click.option(
    "--persistence_stripquotes/--no-persistence_stripquotes",
    help="Enable to automatically strip quotes from the cookie value.",
    show_default=True,
...
@click.option("--stickiness_cookiename", help="Cookie name to use for stick table.", show_default=True, default=None)
@click.option(
    "--stickiness_cookielength",
    help="The maximum number of characters that will be stored in the stick table.",
    show_default=True,
...
@click.option("--tuning_defaultserver", help=("Default option for all server entries."), show_default=True, default=None)
@click.option(
    "--tuning_noport/--no-tuning_noport",
    help=(
        "Don't use port on server, use the same port as frontend receive. " "If check enable, require port check in server."
